...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-body">
          <h4 class="card-title">apis/InsertarEstudiantes.php</h4>
        ...
        <div class="card">
          <div class="card-body">
          <h4 class="card-title">apis/InsertarProfesores.php</h4>
            <blockquote class="blockquote mb-0">
              <p>
                {
                  "cedula" : "8128128",
        ...
        <div class="card">
          <div class="card-body">
          <h4 class="card-title">apis/InsertarCursos.php</h4>
            <blockquote class="blockquote mb-0">
              <p>
               {
                  "nombre":"React 22",
