            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="select_box" class="form-select" id="select_box">
                        ...
                        <option value="a">aaaa Country</option>
                        <option value="ass">Selessct Country</option>
                        <option value="sss">Select Country</option>
                        <option value="aaee">Select Country</option>
