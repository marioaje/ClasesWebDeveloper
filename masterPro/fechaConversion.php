...
$universales = array ( 
   ...
   //var_dump($datos);
    ...
    try {
        if ($query->rowCount() > 0) {
            while($row = $query->fetch()) {  
                ...
                // }        
                $tablaResultado .= '<td class="table-dark">'.consultaUniversales($nica, $universales).'</td>'; 
                $tablaResultado .= '<td class="table-dark">'.consultaUniversales($tica, $universales).'</td>';       
                ...
                // }        
                $tablaResultado .= '<td class="table-dark">'.consultaUniversales($nica, $universales).'  '.consultaUniversales($nicatemp, $universales).'</td>'; 
                $tablaResultado .= '<td class="table-dark">'.consultaUniversales($tica, $universales).'</td>';          
    ...
    function consultaUniversales($consultaUniversales,$universales){
        $td= $consultaUniversales;
