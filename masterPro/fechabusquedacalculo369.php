        ...
        if ($query->rowCount() > 0) {
            while($row = $query->fetch()) {  
                ...
                if (is_numeric($nica)){
                    ...
                    $starts=($nica-1);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                       
                    $resultado = $resultado < 0 ? ($resultado+100)-1 : $resultado;
                    ...
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado = $resultado < 0 ? ($resultado+100)-1 : $resultado;
                    $resultado_6 = $resultado;
                    
                    $starts=($nica-9);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;  
                    $resultado = $resultado < 0 ? ($resultado+100)-1 : $resultado;                                      
                    $resultado_9 = $resultado;       
                    ...
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado6 = $resultado;  //$nica = $nica." ".($nica+2)." ".($nica+3)." ";//.($nica+6)." ".($nica+9);

                    $starts=($nica+9);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado9 = $resultado;  //$nica = $nica." ".($nica+2)." ".($nica+3)." ";//.($nica+6)." ".($nica+9);

                    $nica = $nica." ".$resultado1." ".$resultado2." v3:".$resultado3." v6:".$resultado6." v9:".$resultado9." ";//.($nica+6)." ".($nica+9);
                    $nica = " v9:".$resultado_9." v6:".$resultado_6." v3:".$resultado_3." ".$resultado_2." ".$resultado_1." ".$tempConversion." ".$nica;
                ...
                if (is_numeric($tica)){
                    ...
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado6 = $resultado;  //$tica = $tica." ".($tica+2)." ".($tica+3)." ";//.($tica+6)." ".($tica+9);

                    $starts=($tica+9);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado9 = $resultado;  //$tica = $tica." ".($tica+2)." ".($tica+3)." ";//.($tica+6)." ".($tica+9);

                    $tica = $resultado1." ".$resultado2." v3:".$resultado3." v6:".$resultado6." v9:".$resultado9." ";//.($tica+6)." ".($tica+9);
                    $tica = " v9:".$resultado_9." v6:".$resultado_6." v3:".$resultado_3." ".$resultado_2." ".$resultado_1." ".$tempConversion." ".$tica;
