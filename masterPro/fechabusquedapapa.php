        ...
        if ($query->rowCount() > 0) {
            while($row = $query->fetch()) {  
                ...
                if (is_numeric($nica)){
                    ...
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado4 = $resultado;  //$nica = $nica." ".($nica+2)." ".($nica+3)." ";//.($nica+6)." ".($nica+9);

                    $starts=($nica+5);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado5 = $resultado;  //$nica = $nica." ".($nica+2)." ".($nica+3)." ";//.($nica+6)." ".($nica+9);

                    $nica = $resultado_5." ".$resultado_4." ".$resultado_3." ".$resultado_2." ".$resultado_1." ".$nica." ".$resultado1." ".$resultado2." ".$resultado3." ".$resultado4." ".$resultado5." ";//.($nica+6)." ".($nica+9);
                ...
                if (is_numeric($tica)){
                    ...
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado4 = $resultado;  //$tica = $tica." ".($tica+2)." ".($tica+3)." ";//.($tica+6)." ".($tica+9);

                    $starts=($tica+5);
                    $resultado = strlen($starts) > 2 ? substr($starts,1,2) + substr($starts,0,1) : $starts;
                    $resultado = strlen($resultado) == 1 ? "0".$resultado : $resultado;                                        
                    $resultado5 = $resultado;  //$tica = $tica." ".($tica+2)." ".($tica+3)." ";//.($tica+6)." ".($tica+9);

                    $tica = $resultado_5." ".$resultado_4." ".$resultado_3." ".$resultado_2." ".$resultado_1." ".$tica." ".$resultado1." ".$resultado2." ".$resultado3." ".$resultado4." ".$resultado5." ";//.($tica+6)." ".($tica+9);
